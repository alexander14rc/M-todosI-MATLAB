...
clear all
disp(' RK4 dos EDO :');
f1=input('La EDO Número 1 Dy1Dx=','s');%-0.5*y1+0*y2+y3*0+0*x
f2=input('La EDO Número 2 Dy2Dx=','s');%4-0.3*y2-0.1*y1+y3*0+0*x
f3=input('La EDO Número 3 Dy3Dx=','s');%10-0.5*y2+0.25*y1-0.15*y3+0*x
